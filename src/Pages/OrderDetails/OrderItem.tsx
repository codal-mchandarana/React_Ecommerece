        ...
        <div className="col-lg-4 col-md-6 mb-4 mb-lg-0">
          <div className="d-flex mb-4" style={{ width: "300", height: "40px" }}>
            <div style={{ width: "3rem" }} className="form-outline">
              <p className="form-control pl-5">
                <span style={{ marginLeft: "5px" }}>{data.qty}</span>
              </p>
              <label className="form-label" htmlFor="form1">
                Quantity
              </label>
            </div>
            <div style={{marginLeft:"7rem",position:"relative",bottom:"1rem"}}>
              <p
              ...
              <label style={{position:"relative",top:"30px",right:"2rem"}} className="form-label" htmlFor="form1">
                Price
              </label>
            </div>
          </div>
