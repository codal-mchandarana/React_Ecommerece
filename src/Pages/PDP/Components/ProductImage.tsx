...
const ProductImage: React.FC<product> = ({ currentProduct }): JSX.Element => {
  ...
  const index = carts.findIndex((val) => {
    return val.id === currentProduct?.id;
  });
  const index1 = wishlistItems.findIndex((val) => {
    return val.id === currentProduct?.id;
  });
  ...
  const Price_block = () => {
    const price = calculateOriginalPrice(
          ...
          <div className={`pt-4 wrapper row ${Classes.main_contain}`}>
            <div className={`${Classes.preview} col-md-6`}>
              <div className={`${Classes.preview_pic} tab-content`}>
                <div
                  className={`tab-pane ${selected === 0 && "active"}`}
                  id="pic-1"
                >
                  <img
                ...
                <div
                  className={`tab-pane ${selected === 1 && "active"}`}
                  id="pic-2"
                >
                  <img
                    alt="product-2"
                ...
                <div
                  className={`tab-pane ${selected === 2 && "active"}`}
                  id="pic-3"
                >
                  <img
                    alt="product-3"
                ...
                <div
                  className={`tab-pane ${selected === 3 && "active"}`}
                  id="pic-4"
                >
                  <img
                    alt="product-4"
              ...
              <ul
                className={`${Classes.preview_thumbnail} nav ${Classes.nav_tabs}`}
              >
                <li
                  style={{ border: selected === 0 ? "2px solid gray" : "none" }}
                  onClick={() => {
                    setSelected(0);
                  }}
                  className="active"
                ...
                <li
                  style={{ border: selected === 1 ? "2px solid gray" : "none" }}
                  onClick={() => {
                    setSelected(1);
                  }}
                >
                ...
                <li
                  style={{ border: selected === 2 ? "2px solid gray" : "none" }}
                  onClick={() => {
                    setSelected(2);
                  }}
                >
                ...
                <li
                  ...
                  style={{
                    position: "relative",
                    left: "0.5rem",
                    border: selected === 3 ? "2px solid gray" : "none",
                  }}
                >
            ...
            <div
              ...
              className={`${Classes.details} col-md-6`}
            >
              ...
              <span style={{ position: "relative", bottom: "1rem" }}>
                By :- <a href="">{currentProduct?.brand}</a>
              </span>

              <div className={Classes.rating}>
                <div className="stars">{Rating_block()}</div>
              </div>
              ...
              <h3 style={{ fontWeight: "bold" }}>
                Retail Price:{" "}
                <span
                  style={{ textDecoration: "line-through", fontWeight: "100" }}
                >
                  {" "}
                  ₹{currentProduct?.price}
                </span>
              </h3>
              <h3 style={{ textTransform: "none" }} className={Classes.price}>
                {" "}
                Price: {Price_block()}
              </h3>
              <p style={{ fontSize: "1.1rem" }}>
                ...
                <span style={{ color: "red", fontWeight: "bold" }}>
                  ₹
                  {(parseInt(currentProduct?.price) - discount_price).toFixed(
                    2
                  )}{" "}
                  ({currentProduct?.discountPercentage}%)
                </span>
              ...
              <hr
                style={{ width: "80%", position: "relative", bottom: "1rem" }}
              />

              <div
                style={{ position: "relative", right: "0.7rem" }}
                className="action"
              >
                <button
                  onClick={onClick}
                  className={`${Classes.like} ${Classes.add_to_cart} btn ${Classes.btn_default}`}
                  type="button"
                  disabled={index !== -1}
                >
                  <i
                  ...
                  ></i>
                  {index !== -1 ? "ALREADY IN CART" : "ADD TO CART"}
                </button>
                <button
                  onClick={handleWishlistClick}
                  className={`${Classes.like} btn ${Classes.btn_default}`}
                  type="button"
                  disabled={index1 !== -1}
                >
